    ...
    for line in f:
        try:
            ...
            if data.get("type") == "GENERIC" and "content" in data:
                c = data["content"]
                if "The above content shows the entire, complete file contents of the requested file" in c and "The following are the contents of c:\\Users\\Dell\\AndroidStudioProjects\\ELKKETA\\web_version\\quiz.html" in c:
                    last_content = c
        except:
            pass
